...
It also includes easel.js, which is a compressed version of EaselJS, and is included for the Ticker class, which TweenJS uses. If you don't wish to use EaselJS, you can  implement your own ticking mechanism, or download the Ticker class on it's own from http://github.com/gskinner/easeljs/
