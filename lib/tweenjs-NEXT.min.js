...
(function(){var b=function(d,a,c){this.initialize(d,a,c)},a=b.prototype;a.type=null;a.target=null;a.currentTarget=null;a.eventPhase=0;a.bubbles=!1;a.cancelable=!1;a.timeStamp=0;a.defaultPrevented=!1;a.propagationStopped=!1;a.immediatePropagationStopped=!1;a.initialize=function(d,a,c){this.type=d;this.bubbles=a;this.cancelable=c;this.timeStamp=(new Date).getTime()};a.preventDefault=function(){this.defaultPrevented=!0};a.stopPropagation=function(){this.propagationStopped=!0};a.stopImmediatePropagation=
function(){this.immediatePropagationStopped=this.propagationStopped=!0};a.clone=function(){return new b(this.type,this.bubbles,this.cancelable)};a.toString=function(){return"[Event (type="+this.type+")]"};createjs.Event=b})();this.createjs=this.createjs||{};
(function(){var b=function(){this.initialize()},a=b.prototype;b.initialize=function(d){d.addEventListener=a.addEventListener;d.removeEventListener=a.removeEventListener;d.removeAllEventListeners=a.removeAllEventListeners;d.hasEventListener=a.hasEventListener;d.dispatchEvent=a.dispatchEvent;d._dispatchEvent=a._dispatchEvent};a._listeners=null;a._captureListeners=null;a.initialize=function(){};a.addEventListener=function(d,a,c){var b;b=c?this._captureListeners=this._captureListeners||{}:this._listeners=
this._listeners||{};var f=b[d];f?(this.removeEventListener(d,a,c),f.push(a)):b[d]=[a];return a};a.removeEventListener=function(d,a,c){if(c=c?this._captureListeners:this._listeners){var b=c[d];if(b)for(var f=0,g=b.length;f<g;f++)if(b[f]==a){1==g?delete c[d]:b.splice(f,1);break}}};a.removeAllEventListeners=function(d){d?(this._listeners&&delete this._listeners[d],this._captureListeners&&delete this._captureListeners[d]):this._listeners=this._captureListeners=null};a.dispatchEvent=function(d,a){if("string"==
typeof d){var c=this._listeners;if(!c||!c[d])return!1;d=new createjs.Event(d)}d.target=a||this;if(!d.bubbles||!this.parent)this._dispatchEvent(d,this,2);else{for(var b=this,c=[b];b.parent;)c.push(b=b.parent);for(var f=c.length,b=f-1;0<=b&&!d.propagationStopped;b--)c[b]._dispatchEvent(d,c[b],1+(0==b));for(b=1;b<f&&!d.propagationStopped;b++)c[b]._dispatchEvent(d,c[b],3)}return d.defaultPrevented};a.hasEventListener=function(d){var a=this._listeners,c=this._captureListeners;return!!(a&&a[d]||c&&c[d])};
a.toString=function(){return"[EventDispatcher]"};a._dispatchEvent=function(d,a,c){var b,f=!1,g=1==c?this._captureListeners:this._listeners;if(d&&g&&(g=g[d.type])&&(b=g.length)){d.currentTarget=a;d.eventPhase=c;g=g.slice();for(a=0;a<b&&!d.immediatePropagationStopped;a++)c=g[a],f=c.handleEvent?f||c.handleEvent(d):f||c(d)}};createjs.EventDispatcher=b})();this.createjs=this.createjs||{};
...
g[j].splice(k,0,d)}else g[j]=[d]}};b._register=function(d,a){var c=d._target,e=b._tweens;if(a)c&&(c.tweenjs_count=c.tweenjs_count?c.tweenjs_count+1:1),e.push(d);else{c&&c.tweenjs_count--;for(c=e.length;c--;)if(e[c]==d){e.splice(c,1);break}}};a.addEventListener=null;a.removeEventListener=null;a.removeAllEventListeners=null;a.dispatchEvent=null;a.hasEventListener=null;a._listeners=null;createjs.EventDispatcher.initialize(a);a.ignoreGlobalPause=!1;a.loop=!1;a.duration=0;a.pluginData=null;a.target=null;
a.position=null;a.passive=!1;a._paused=!1;a._curQueueProps=null;a._initQueueProps=null;a._steps=null;a._actions=null;a._prevPosition=0;a._stepPosition=0;a._prevPos=-1;a._target=null;a._useTicks=!1;a.initialize=function(d,a,c){this.target=this._target=d;a&&(this._useTicks=a.useTicks,this.ignoreGlobalPause=a.ignoreGlobalPause,this.loop=a.loop,a.onChange&&this.addEventListener("change",a.onChange),a.override&&b.removeTweens(d));this.pluginData=c||{};this._curQueueProps={};this._initQueueProps={};this._steps=
...
function(a){this._paused=!!a;b._register(this,!a);return this};a.w=a.wait;a.t=a.to;a.c=a.call;a.s=a.set;a.toString=function(){return"[Tween]"};a.clone=function(){throw"Tween can not be cloned.";};a._updateTargetProps=function(a,h){var c,e,f,g;if(!a&&1==h)this.passive=!1,c=e=this._curQueueProps;else{if(this.passive=!!a.v)return;a.e&&(h=a.e(h,0,1,1));c=a.p0;e=a.p1}for(n in this._initQueueProps){if(null==(f=c[n]))c[n]=f=this._initQueueProps[n];if(null==(g=e[n]))e[n]=g=f;f=f==g||0==h||1==h||"number"!=
typeof f?1==h?g:f:f+(g-f)*h;var j=!1;if(g=b._plugins[n])for(var l=0,k=g.length;l<k;l++){var p=g[l].tween(this,n,f,c,e,h,!!a&&c==e,!a);p==b.IGNORE?j=!0:f=p}j||(this._target[n]=f)}};a._runActions=function(a,b,c){var e=a,f=b,g=-1,j=this._actions.length,l=1;a>b&&(e=b,f=a,g=j,j=l=-1);for(;(g+=l)!=j;){b=this._actions[g];var k=b.t;(k==f||k>e&&k<f||c&&k==a)&&b.f.apply(b.o,b.p)}};a._appendQueueProps=function(a){var h,c,e,f,g,j;for(j in a){if(void 0===this._initQueueProps[j]){c=this._target[j];if(h=b._plugins[j]){e=
0;for(f=h.length;e<f;e++)c=h[e].init(this,j,c)}this._initQueueProps[j]=void 0===c?null:c}else c=this._curQueueProps[j];if(h=b._plugins[j]){g=g||{};e=0;for(f=h.length;e<f;e++)h[e].step&&h[e].step(this,j,c,a[j],g)}this._curQueueProps[j]=a[j]}g&&this._appendQueueProps(g);return this._curQueueProps};a._cloneProps=function(a){var b={},c;for(c in a)b[c]=a[c];return b};a._addStep=function(a){0<a.d&&(this._steps.push(a),a.t=this.duration,this.duration+=a.d);return this};a._addAction=function(a){a.t=this.duration;
this._actions.push(a);return this};a._set=function(a,b){for(var c in a)b[c]=a[c]};createjs.Tween=b})();this.createjs=this.createjs||{};
